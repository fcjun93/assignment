...
public class Module3 {
    ...
    private static BigDecimal totalPriceFormat;
        ...
        do {
            ...
            do {
                ...
                if (continueOrder == true) {
                    ...
                    totalPrice += amount;
                    totalPriceFormat = round((float) totalPrice, 2);
                    currentOrder.add(new Order(item, unitPrice, quantity, result));
                    displayList(currentOrder);
                    System.out.println("                                                                 ===========");
                    System.out.println(priceJustified(totalPriceFormat.toString(), 75));
                    System.out.println("                                                                 ===========");
                    System.out.println("");
                    ...
                    do {
                        ...
                        if (option == 1) {
                            ...
                            System.out.println(priceJustified(totalPriceFormat.toString(), 75));
                            System.out.println("                                                                 ===========");
                            System.out.println("\nYour order will be delivered shortly. Thank you for choosing Fastest Deliveryman. ");
                            continueOrder = false;
                            System.exit(0);
                            break;
                        } else {
